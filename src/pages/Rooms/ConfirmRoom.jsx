            ...
            <div className="row">
                <div className="col-md-8 m-auto">
                    <div className="card p-3 p-md-5 border-0 w-100">
                        ...
                        <span className="fs-6 d-block mt-2"><b>{selectedLanguage === 'english' ? 'Check In: ' : translateToKannada('Event start date')}<span className="text-secondary">{formateDate(formData.checkIn)}</span></b></span>
                        <span className="fs-6 d-block mt-2"><b>{selectedLanguage === 'english' ? 'Check Out: ' : translateToKannada('Event start date')}<span className="text-secondary">{formateDate(formData.checkOut)}</span></b></span>
